...
export class MedicalHistoryComponent    {
  ...
  constructor(private router: Router) {}
   // Fonction pour faire défiler vers une section dans la page de vue d'ensemble
  // S'assure que nous sommes sur la page de vue d'ensemble avant de tenter de faire défiler
  scrollToSection(sectionId: string): void {
    if (this.router.url.includes('/overview')) {
      ...
      // Naviguer vers la vue d'ensemble puis faire défiler
      this.router.navigate(['./overview'], { relativeTo: this.router.routerState.root.firstChild?.firstChild }).then(() => {
